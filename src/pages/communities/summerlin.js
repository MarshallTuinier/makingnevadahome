    ...
    <div>
      ...
      <StyledPage>
        ...
        <p>
          ...
          Nevada. Standing a the foothills of the Las Vegas Valley, this master
          planned community makes the best case for desert living. It is
          adjacent to the famous Red Rock Canyon National Conservation Area.
          Making the most of its location’s wide and open spaces, a diverse
          collection of parks and neighborhoods, world-class recreational areas,
          and an outstanding way of life, Summerlin makes it very clear why it
          is the “chief community” in the Las Vegas Valley area. It is 22,500
          acres of prime living space.
          <br />
          <br />
          The main draw to living in Summerlin is summed up by Money magazine
          which named it the one of best reasons to live in the Vegas area. The
          publication highlighted its careful maintenance of residential,
          commercial, and civic features. This New Urbanist layering has turned
          and maintained Summerlin’s pleasant neighborhoods and in turn this
