  ...
  return(
    ...
    <UnderNavImg />
      <StyledPage>
        ...
        <p>
          What a lot of people don’t realize about Boulder City is that it’s a gem in the desert that’s just waiting to be discovered; a wonderful little desert town that lies
          just about 26 miles southeast of the city of Las Vegas, a short half an hour drive away.
          <br/>
          <br/>
          Boulder City is a uniquely charming place to live, like the Hoover Dam, the town itself was meant to be built as a manifestation of optimism in a nation recovering
          from the Great Depression, by Dutch-born urban architect  Saco Rienk de Boer, who placed an emphasis on having a clean-living environment for its residents.
        </p>
        <HR />
        <h2>
